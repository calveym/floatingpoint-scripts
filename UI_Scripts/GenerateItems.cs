...
public class GenerateItems : MonoBehaviour {
    ...
    public void GenerateButton1()
    {
		...
		GameObject tempObject = Object.Instantiate(lrgCommercial[index], controller.transform.position , Quaternion.identity);
        ItemTracker itemTracker = tempObject.GetComponent<ItemTracker>();
        itemTracker.addType("commercial");
        itemTracker.addCapacity(5);
    }
