...
public class RoadSnap : MonoBehaviour {
	...
	List<StringFloat> getSnapPoints(GameObject currentObject) {
		...
		Vector3 thisTopLeft = RotatePointAroundPivot (targetBuildingScript.topLeft, currentObject.transform.position, currentObject.transform.eulerAngles);
		Vector3 thisBottomLeft = RotatePointAroundPivot (targetBuildingScript.bottomLeft, currentObject.transform.position, currentObject.transform.eulerAngles);
		Vector3 thisTopRight = RotatePointAroundPivot (targetBuildingScript.topRight, currentObject.transform.position, currentObject.transform.eulerAngles);
		Vector3 thisBottomRight = RotatePointAroundPivot (targetBuildingScript.bottomRight, currentObject.transform.position, currentObject.transform.eulerAngles);
	...
	StringFloat getClosestSnapPoint() {
		...
		List<StringFloat> snapPoints = getSnapPoints(objectToPlace);
